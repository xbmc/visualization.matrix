    ...
    m_pcm(new float[AUDIO_BUFFER]())
{
  ...
  m_noiseFluctuation = m_lowpower ? static_cast<float>(kodi::GetSettingInt("noisefluctuation")) * 0.0002f : static_cast<float>(kodi::GetSettingInt("noisefluctuation")) * 0.002f;
